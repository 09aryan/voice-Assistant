...
//import 'package:app_second/screens/voice_to_text.dart';
//import 'package:app_second/services/tts.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        '/signup': (BuildContext context) => const MyResgistar()
      },
    );
  }
}
